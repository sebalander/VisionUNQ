...
def draw_info(res, vg):
    ...
    draw_str(res, (20, 60),
        "freq. proceso  :  %.1f fps" % (1/vg.mt.latency.value))
    draw_str(res, (20, 80),
        "freq. descarga :  %.1f fps" % (1/vg.mt.frame_interval.value))
            ...
            if vg.captura.isReady():
                ...
                if ret:
                    ...
                    if vg.threaded_mode:
                        ...
                        task = DummyTask(video_process.process_frame(im_frame, vg, t))
